var Inbox = function () {
    ...
    var loadInbox = function (el, name) {
        var url = SITE_URL+'inbox_inbox.html';
    ...
    var loadMessage = function (el, name, resetMenu) {
        var url = SITE_URL+'inbox_view.html';
    ...
    var initWysihtml5 = function () {
        $('.inbox-wysihtml5').wysihtml5({
            "stylesheets": [SITE_URL+"assets/global/plugins/bootstrap-wysihtml5/wysiwyg-color.css"]
        });
    }
    ...
    var initFileupload = function () {
        ...
        $('#fileupload').fileupload({
            ...
            url: SITE_URL+'assets/global/plugins/jquery-file-upload/server/php/',
            autoUpload: true
        });
    ...
    var loadCompose = function (el) {
        var url = SITE_URL+'inbox_compose.html';
    ...
    var loadReply = function (el) {
        ...
        var url = SITE_URL+'inbox_reply.html?messageid=' + messageid;
